...
function SpRmApplicationForm(){
	...
	$i['sign'] = $_POST['sign'];
foreach($i as $key=>$value){ if(is_null($value)){ unset($i[$key]); } }
	...
	dlgAdminEmail(__("New Rental Application","sp-rm"),$body);
...
<h2>Reference</h2>
<p>Please list personal references: (Not Relatives)</p>
		<table width="100%" border="0" cellspacing="3" cellpadding="3">
  <tr>
    <td>Name:</td>
